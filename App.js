...
import {
  ...
  ToastAndroid, TextInput, Dimensions, ScrollView
} from 'react-native';
...
export default class App extends Component {
  ...
  showicon = (row, col) => {
    ...
    switch (value) {
      case 1: return <Icon name="close" style={styles.closeicon} />;
      case -1: return <Icon name="circle-outline" style={styles.circleicon} />
      default: return <View />
    }
  }
  ...
  touchbox = (row, col) => {
    ...
    if (this.state.computer == false) {
      ...
      if (winner == 1) {
        ToastAndroid.showWithGravity(`${this.state.player1} win the match !!`, ToastAndroid.SHORT, ToastAndroid.BOTTOM);
        setTimeout(() => {
        ...
        ToastAndroid.showWithGravity(`${this.state.player2} win the match !!`, ToastAndroid.SHORT, ToastAndroid.BOTTOM);
        setTimeout(() => {
  ...
  computer = () => {
    ...
    var row = number[random][0];
    var col = number[random][1];
    var value = this.state.tictactoe[row][col];
        ...
        <View style={styles.container}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="always">
            ...
            <View>
              ...
              {/* player 1 */}
              <View style={{ marginTop: height * 5 / 100, alignItems: 'center' }}>
                <TextInput
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (this.state.player1 == "" || this.state.player2 == "") {
                    ToastAndroid.showWithGravity(`Names are require to play`, ToastAndroid.SHORT, ToastAndroid.BOTTOM);
                  }
                  else {
                    this.start();
                  }
